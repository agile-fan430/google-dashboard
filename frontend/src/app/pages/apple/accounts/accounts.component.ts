...
export class AccountsComponent {
  baseURL: string = 'http://155.138.239.244:3001/customers';
  // baseURL: string = 'http://localhost:3001/customers';
    ...
    columns: {
      ...
      active: {
        ...
        editor: {
          type: 'list',
          config: {
            list: [{ value: 'Active', title: 'Active'}, { value: 'Block', title: 'Block'}],
          },
        },
        filter: false,
      },
  ...
  getDataRecordsArrayFromCSVFile(csvRecordsArray: any, headerLength: any) {
    ...
    for (let i = 1; i < csvRecordsArray.length; i++) {
      ...
      if (curruntRecord.length === headerLength) {
        ...
        csvRecord.bot_id = curruntRecord[3].trim();
        csvRecord.proxy = curruntRecord[4].trim();
        csvRecord.active = curruntRecord[5].trim();
        csvRecord.security = curruntRecord[6].trim();
